...
@main_bp.route('/goal/edit/<int:goal_id>', methods=['GET', 'POST'])
@login_required
...
@main_bp.route('/financial-planning/edit/<int:item_id>', methods=['POST'])
@login_required
def edit_plan_item(item_id):
    ...
    return redirect(url_for('main.financial_planning'))


@main_bp.route('/financial-planning/delete/<int:item_id>', methods=['POST'])
@login_required
...
@main_bp.route('/financial-planning', methods=['GET', 'POST'])
@login_required
